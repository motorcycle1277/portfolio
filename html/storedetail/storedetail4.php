...
//ID1のお店のデータを出力##storeIDは変更すること##
try{
foreach($pdo->query('select * from information where storeID = 4') as $row){
...
//ID1のお店のユーザー評価を出力する##storeIDは変更すること##
echo "<div class='Evaluation'>";
try{
  foreach ($pdo->query('select * from review where storeID = "4"') as $row2) {
    // code...
